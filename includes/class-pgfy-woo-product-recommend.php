...
class Pgfy_Woo_Product_Recommend {
    ...
    * @since      1.0.0
	...
	public function admin_enqueue_scripts() {
		wp_enqueue_script('wpr-script', $this->get_url('assects/js/panel.build.js'), array('wp-element','jquery'), false, true);
	...
	public function wp_enqueue_scripts() {
		...
		if(is_product()) {
			wp_enqueue_script('wpr-ajax-add-to-cart', $this->get_url('assects/js/ajax-add-to-cart.js'), array('jquery'), false, true);
		}
