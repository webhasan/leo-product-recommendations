    ...
    public function section_tab($page) { ?>
		...
		<div class="nav-tab-wrapper">
			<?php foreach( $sections as $section) : ?>
				<a href="?page=<?php echo $page['slug']; ?>&sec=<?php echo $section['id'];  ?>" class="nav-tab <?php if($active_section == $section['id']) echo ' nav-tab-active'; ?>"><?php echo $section['tab_title'] ?></a>
			<?php endforeach; ?>
		</div>
		<?php
    }
