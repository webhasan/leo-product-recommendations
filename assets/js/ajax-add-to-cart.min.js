...
(function ($) {
  $(function () {
    ...
    $('body').on('submit', 'form.cart', function (e) {
      ...
      data.product_id = $submitButton.val() ? $submitButton.val() : productId; // recommendation products modal.

      var $targetModal = $('#lpr-modal-' + data.product_id); //$targetModal.length || $form.closest('.lpr-modal-body').length
