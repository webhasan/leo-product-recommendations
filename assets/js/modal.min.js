          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                recommendedProducts = [];
                productDataSpan = $(button).parent().find('.product-recommendations-data');
              ...
              case 10:
                ...
                recommendedProducts = recommendedProducts.filter(function (id) {
                  return !cartItems.includes(id);
                });
                console.log(recommendedProducts); //don't show modal inside modal
              ...
              case 16:
                ...
                $('body, .quickview-wrapper .closeqv, .yith-quick-view-overlay, .mfp-wrap').click(); //modal 
              ...
              case 19:
                modal = _context.sent;
                $('body').append(modal);
                $('.lpr-modal').lprModal(); // if (lc_ajax_modal.layout_type === "slider") {
