...
(function ($) {
  ...
  $(function () {
    ...
    $(document.body).on("added_to_cart", function (e) {
      ...
      var addedProductId = $(button).data("product_id"); //don't show modal inside modal
      ...
      if (!$(button).closest(".recommended-products-wrapper").length) {
        ...
        $notification_bar.fadeIn(100).text("".concat(notificationText, " has been added to cart."));
        setTimeout(function () {
