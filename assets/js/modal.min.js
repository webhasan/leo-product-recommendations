...
(function ($, __) {
  ...
  function setPopupCount() {
    var prevPopupCountData = localStorage.getItem('lpr-popup-count');
    var hasPrevCount = prevPopupCountData && JSON.parse(prevPopupCountData).count && JSON.parse(prevPopupCountData).time > Date.now() - 2 * 3600 * 1000;
    var popupCount = hasPrevCount ? JSON.parse(prevPopupCountData).count + 1 : 1;
    var popupCountData = {
      count: popupCount,
      time: Date.now()
    };
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                popupCount = getPopupCount(); // fallback for older version of pro plugin

                if (!lc_ajax_modal.popup_view_times) lc_ajax_modal.popup_view_times = 'always';
                popupShowTimes = lc_ajax_modal.popup_view_times === 'always' ? Infinity : +lc_ajax_modal.popup_view_times;
