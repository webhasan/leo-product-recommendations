            ...
            <div class="wpr-modal-head">
                ...
                <div class="wpr-message" role="alert">
                    <div class="message-text">
                        ...
                        ?>
                        <span class="wpr-notification-text"><strong class="product-modal"><?php echo get_the_title($product_id); ?></strong> <?php _e('has been added to your cart.', 'woo-product-recommendations'); ?></span>
                        <a href="<?php echo wc_get_cart_url(); ?>" class="wpr-cart-button"><?php _e('View cart', 'woo-product-recommendations'); ?> &rarr; </a>
                    </div>

                    <?php if(apply_filters('wpr_show_buttons', true)): ?>
                    <div class="right-buttons">
                        <?php if(apply_filters('wpr_show_continue_shopping', true)): ?>
                        <a href="#" class="wpr-close-modal wpr-button"><?php _e('Continue Shopping', 'woo-product-recommendations'); ?></a>
                        <?php endif; ?>

                        <?php if(apply_filters('wpr_go_checkout', true)): ?>
                        <a href="<?php echo wc_get_checkout_url(); ?>" class="wpr-button"><?php _e('Checkout', 'woo-product-recommendations'); ?></a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
